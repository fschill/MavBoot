...
// use non-inlined crc16 code if optimizing for size, e.g. in bootloader (saves a few 100 bytes)
// including the small_checksum.h file here will prevent mavlink from including the regular checksum.h 
// as the header is already defined.

#ifdef __OPTIMIZE_SIZE__
#include "small_checksum.h"
#endif

// test if endian-ness auto selection in conf_mavlink.h is working
//#ifdef NATIVE_BIG_ENDIAN 
//#error "big endian!"
//#endif

//#include "mavlink/include/maveric/mavlink.h"
#include "mavlink/include/dbgextensions/mavlink.h"
